...
% Last Modified by GUIDE v2.5 07-Apr-2021 19:34:12
...
elseif (panjang == 0)
    set(handles.lebar,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Panjang tidak boleh bernilai nol!','Ada yang Salah?');
elseif (panjang < 0)
    set(handles.lebar,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Panjang tidak boleh bernilai minus!','Ada yang Salah?');
...
elseif (lebar == 0)
    set(handles.tinggi,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Lebar tidak boleh bernilai nol!','Ada yang Salah?');
elseif (lebar < 0)
    set(handles.tinggi,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Lebar tidak boleh bernilai minus!','Ada yang Salah?');
...
elseif (tinggi == 0)
    ...
    set(handles.luasbalok,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Tinggi tidak boleh bernilai nol!','Ada yang Salah?');
elseif (tinggi < 0)
    set(handles.volumebalok,'Enable', 'off');
    set(handles.luasbalok,'Enable', 'off');
    set(hObject, 'String', '');
    errordlg('Tinggi tidak boleh bernilai minus!','Ada yang Salah?');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
selection=questdlg(['Anda yakin ingin menutup program',' ?'],...
    ['bertanya' '' '...'],...
    'Ya', 'Batal', 'Ya');
if stramp(selection,'Batal')
    return
end
close;
...
if (hObject == handles.volumebalok)
    set(handles.hasil_text, 'String', 'Volume Balok')
...
functing initialize_gui(fig_handle, handles, isreset)

if is field(handles, 'metricdata') && ~isreset
    return;
end
